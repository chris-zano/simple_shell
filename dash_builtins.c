...
/**
 * dash_setenv - implements setenv function
 * @args: An array of arguments passed to the shell.
 * @front: command to execute
 * Return: 0 (success)
 */
...
/**
 * dash_unsetenv - Deletes an environmental variable from the PATH.
 * @args: An array of arguments passed to the shell.
 * @front: command argument to be passed
 * Return: 0 (success)
 */
